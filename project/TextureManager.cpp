...
void TextureManager::LoadTexture(const std::string& filePath)
{
 ...
 // ローカル変数としてScratchImageを生成
	...
	textureData.resource = dxCommon->CreateTextureResource(textureData.metadata);//テクスチャリソース生成
	...
	dxCommon->GetDevice()->CreateShaderResourceView(textureData.resource.Get(), &srvDesc, textureData.srvHandleCPU);//設定をもとにSRVの生成
